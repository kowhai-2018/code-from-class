...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = App.__proto__ || Object.getPrototypeOf(App)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState((_this$setState = {}, _defineProperty(_this$setState, e.target.name, e.target.value), _defineProperty(_this$setState, 'message', message), _this$setState));
    }, _this.submitHandler = function (e) {
      e.preventDefault();

      // Final validation before submitting to server
      console.log('SUBMITTED:', _this.state.username, _this.state.password);
